...
internal sealed class MetalGuestGpuBackend : IGuestGpuBackend
{
    ...
    public void RegisterKnownDisplayBuffer(ulong address, uint guestFormat, uint width, uint height) =>
        MetalVideoPresenter.RegisterKnownDisplayBuffer(address, guestFormat, width, height);
